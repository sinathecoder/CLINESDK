 ...
 */
export type OrchestrationConfigRefOverride = Omit<PartialOrchestrationConfig, 'stream'> & {
 ...
 */
export type OrchestrationConfigRef = Xor<OrchestrationConfigRefById, OrchestrationConfigRefByName> & {
    /**
     * Optional partial configuration to override parts of the stored orchestration config at request time.
     */
    overrideConfig?: OrchestrationConfigRefOverride;
 ...
 */
export declare function isConfigReference(config: OrchestrationModuleConfig | OrchestrationModuleConfigList | string | OrchestrationConfigRefById | OrchestrationConfigRefByName): config is OrchestrationConfigRefById | OrchestrationConfigRefByName;
/**
 ...
 */
export declare function assertIsOrchestrationModuleConfigList(config: OrchestrationModuleConfig | OrchestrationModuleConfigList | string | OrchestrationConfigRefById | OrchestrationConfigRefByName): asserts config is OrchestrationModuleConfigList;
/**
 ...
 */
export declare function isOrchestrationModuleConfigList(config: OrchestrationModuleConfig | OrchestrationModuleConfigList | string | OrchestrationConfigRefById | OrchestrationConfigRefByName): config is OrchestrationModuleConfigList;
/**
