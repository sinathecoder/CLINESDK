...
import type { EmbeddingModuleConfig, EmbeddingRequest } from './orchestration-types.ts';
...
export declare class OrchestrationEmbeddingClient {
     ...
     */
    constructor(config: EmbeddingModuleConfig, deploymentConfig?: ResourceGroupConfig | DeploymentIdConfig, destination?: HttpDestinationOrFetchOptions);
    /**
