 ...
 */
export type GcpVertexAiChatModel = LiteralUnion<'gemini-2.5-flash' | 'gemini-2.5-flash-lite' | 'gemini-2.5-pro' | 'gemini-3.1-flash-lite' | 'gemini-3.5-flash'>;
/**
 ...
 */
export type AwsBedrockChatModel = LiteralUnion<'amazon--nova-pro' | 'amazon--nova-lite' | 'amazon--nova-micro' | 'anthropic--claude-4.5-haiku' | 'anthropic--claude-4.6-opus' | 'anthropic--claude-4.5-sonnet' | 'anthropic--claude-4.6-sonnet' | 'anthropic--claude-4.7-opus' | 'anthropic--claude-4.5-opus' | 'anthropic--claude-4.8-opus'>;
/**
