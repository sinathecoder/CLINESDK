...
import { LanguageModelV4, LanguageModelV4CallOptions, LanguageModelV4Content, LanguageModelV4FinishReason, LanguageModelV4Usage, SharedV4Warning, LanguageModelV4ResponseMetadata, SharedV4Headers, LanguageModelV4StreamPart, EmbeddingModelV4, SharedV4ProviderMetadata, ImageModelV4, ImageModelV4CallOptions, ImageModelV4ProviderMetadata, ImageModelV4Usage, Experimental_VideoModelV4, Experimental_VideoModelV4CallOptions, Experimental_VideoModelV4VideoData, ProviderV4 } from '@ai-sdk/provider';
export { LanguageModelV4, LanguageModelV4Prompt } from '@ai-sdk/provider';
import { ProviderDefinedToolFactory } from '@ai-sdk/provider-utils';
...
declare class OpenRouterChatLanguageModel implements LanguageModelV4 {
...
declare class OpenRouterCompletionLanguageModel implements LanguageModelV4 {
    readonly specificationVersion: "v4";
    readonly provider = "openrouter";
    ...
    private getArgs;
    doGenerate(options: LanguageModelV4CallOptions): Promise<Awaited<ReturnType<LanguageModelV4['doGenerate']>>>;
    doStream(options: LanguageModelV4CallOptions): Promise<Awaited<ReturnType<LanguageModelV4['doStream']>>>;
}
...
declare class OpenRouterEmbeddingModel implements EmbeddingModelV4 {
    readonly specificationVersion: "v4";
    readonly provider = "openrouter";
    ...
    doEmbed(options: {
        ...
        warnings: Array<_ai_sdk_provider.SharedV4Warning>;
    }>;
}
...
declare class OpenRouterImageModel implements ImageModelV4 {
    readonly specificationVersion: "v4";
    readonly provider = "openrouter";
...
declare class OpenRouterVideoModel implements Experimental_VideoModelV4 {
    readonly specificationVersion = "v4";
    readonly provider = "openrouter";
    ...
    doGenerate(options: Experimental_VideoModelV4CallOptions): Promise<{
