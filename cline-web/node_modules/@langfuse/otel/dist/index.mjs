...
var LangfuseSpanProcessor = class {
  ...
  constructor(params) {
    ...
    const exporter = (_k = params == null ? void 0 : params.exporter) != null ? _k : new OTLPTraceExporter({
    ...
    this.environment = (_l = params == null ? void 0 : params.environment) != null ? _l : getEnv("LANGFUSE_TRACING_ENVIRONMENT");
    this.release = (_m = params == null ? void 0 : params.release) != null ? _m : getEnv("LANGFUSE_RELEASE");
  ...
  onStart(span, parentContext) {
    ...
    if (span.attributes[LangfuseOtelSpanAttributes2.OBSERVATION_PROMPT_NAME] != null) {
      delete propagatedAttributes[LangfuseOtelSpanAttributes2.OBSERVATION_PROMPT_NAME];
      delete propagatedAttributes[LangfuseOtelSpanAttributes2.OBSERVATION_PROMPT_VERSION];
    }
    span.setAttributes({
