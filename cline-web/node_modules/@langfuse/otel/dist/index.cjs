...
var MediaService = class {
          ...
          if (Array.isArray(parsed)) {
            for (const message of parsed) {
              ...
              for (const part of message["parts"]) {
                ...
                if (part["type"] !== "blob" || typeof content !== "string" || !content || typeof mediaType !== "string" || content.startsWith("http")) {
                  continue;
                }
  ...
  async replaceBytesMedia(params) {
    var _a;
    const media = new import_core.LangfuseMedia({
      contentType: params.contentType,
      contentBytes: (0, import_core.base64ToBytes)(params.base64Content),
      source: "bytes"
    });
    const langfuseMediaTag = await media.getTag();
    if (!langfuseMediaTag) {
    ...
    return params.mediaReplacedValue.replaceAll(
      (_a = params.contentToReplace) != null ? _a : params.base64Content,
      langfuseMediaTag
    );
  }
  ...
  async handleUpload({
    ...
    try {
      await (0, import_core.uploadMedia)({
...
var LangfuseSpanProcessor = class {
  ...
  constructor(params) {
    ...
    const envMediaUploadEnabled = (0, import_core3.getEnv)("LANGFUSE_MEDIA_UPLOAD_ENABLED");
    const mediaUploadEnabled = (_j = params == null ? void 0 : params.mediaUploadEnabled) != null ? _j : envMediaUploadEnabled ? !["false", "0"].includes(envMediaUploadEnabled.toLowerCase()) : true;
    const exporter = (_k = params == null ? void 0 : params.exporter) != null ? _k : new import_exporter_trace_otlp_http.OTLPTraceExporter({
    ...
    this.environment = (_l = params == null ? void 0 : params.environment) != null ? _l : (0, import_core3.getEnv)("LANGFUSE_TRACING_ENVIRONMENT");
    this.release = (_m = params == null ? void 0 : params.release) != null ? _m : (0, import_core3.getEnv)("LANGFUSE_RELEASE");
    this.mask = params == null ? void 0 : params.mask;
    this.shouldExportSpan = (_n = params == null ? void 0 : params.shouldExportSpan) != null ? _n : ({ otelSpan }) => isDefaultExportSpan(otelSpan);
  ...
  onStart(span, parentContext) {
    const propagatedAttributes = (0, import_core3.getPropagatedAttributesFromContext)(parentContext);
    if (span.attributes[import_core3.LangfuseOtelSpanAttributes.OBSERVATION_PROMPT_NAME] != null) {
      delete propagatedAttributes[import_core3.LangfuseOtelSpanAttributes.OBSERVATION_PROMPT_NAME];
      delete propagatedAttributes[import_core3.LangfuseOtelSpanAttributes.OBSERVATION_PROMPT_VERSION];
    }
    span.setAttributes({
