...
import type { ClineCoreStartConfig, CoreSessionConfig } from "../../types/config";
...
export interface ResolvedStartSessionInput extends Omit<StartSessionInput, "config"> {
    config: RuntimeSessionConfig;
}
export declare function splitCoreSessionConfig(config: ClineCoreStartConfig): {
    config: StartSessionConfig;
    localRuntime?: LocalRuntimeStartOptions;
};
